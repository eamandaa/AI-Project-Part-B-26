...
metadata = {
    ...
    "team_name": f"candymandy", 

    # Fill in the student IDs and emails of both team members here. There must
    # be exactly two members in the list. 
    "team_members": [
        {
            "name": "Ee Wan Rong Amanda",
            "student_id": "1514578",
            "email": "eamanda@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Jia Yi Tong",
            "student_id": "1518405",
            "email": "jttong2@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
