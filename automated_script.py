...
def main():
    ...
    print("\n\n--- RESULTS ---")
    print(f"Player 1 {args.agent_one} = {num_win_player_one}, win rate = {num_win_player_one / total_round_game * 100:.2f}%")
    print(f"Player 2 {args.agent_two} = {num_win_player_two}, win rate = {num_win_player_two / total_round_game * 100:.2f}%")
