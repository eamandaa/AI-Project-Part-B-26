...
from .move_generation import all_legal_actions_during_place, all_legal_actions_during_play
...
class Agent:
    ...
    def action(self, **referee: dict) -> Action:
        ...
        if self._turn_count < 4: 
            match self._color:
                case PlayerColor.RED:
                    action = all_legal_actions_during_place(self._board, self._board.turn_count)
        ...
        match self._color:
            case PlayerColor.RED:
                ...
                return all_legal_actions_during_play(self._board)
            case PlayerColor.BLUE:
