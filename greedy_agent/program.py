...
from .play_phase_heuristic import choose_best_action_during_play
...
class Agent:
    ...
    def action(self, **referee: dict) -> Action:
        ...
        if self._turn_count < 4: 
            match self._color:
                case PlayerColor.RED:
                    action = choose_best_action_during_placement(self._board, self._board.turn_count)
        ...
        match self._color:
            case PlayerColor.RED:
                ...
                return choose_best_action_during_play(self._board)
            case PlayerColor.BLUE:
